      ...
      <div className="mx-auto max-w-[1440px] px-5 py-14 sm:px-8 lg:px-10 lg:py-18">
        <div className="grid gap-12 border-b border-white/15 pb-12 sm:grid-cols-2 lg:grid-cols-[1.35fr_0.8fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-5 max-w-sm text-sm leading-6 text-slate-200">{footer.summary}</p>
          ...
          <div>
            ...
            <div className="mt-5 space-y-4 text-sm">
              <a href="mailto:105792539@qq.com" className="block text-slate-100 hover:text-white">105792539@qq.com</a>
              <a href="tel:+8613871215656" className="block text-slate-100 hover:text-white">+86 138 7121 5656</a>
          ...
          <div>
            ...
            <dl className="mt-5 space-y-5 text-sm">
              <div><dt className="text-slate-400">{footer.establishedLabel}</dt><dd className="mt-1 text-slate-100">{footer.establishedValue}</dd></div>
              <div><dt className="text-slate-400">{footer.locationsLabel}</dt><dd className="mt-1 text-slate-100">{footer.locationsValue}</dd></div>
            </dl>
          </div>
        </div>
